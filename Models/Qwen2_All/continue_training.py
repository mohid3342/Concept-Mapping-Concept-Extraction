...
#Testing Starts Here CS0441





training_data = "train_without_cs0441_03_27.jsonl"
testing_data = "test_cs0441_03_27.jsonl"
test_labels = "concepts_cs0441.txt"
...
with open('evaluation_results_cs0441_testCode.json', 'w') as f:
    json.dump(results, f, indent=2)

print("\n" + "="*60)
print("Results saved to 'evaluation_results_cs0441_testCode.json'")
print("="*60)




#Training Starts here CS0449





training_data = "train_without_cs0449_03_27.jsonl"
testing_data = "test_cs0449_03_27.jsonl"
test_labels = "concepts_cs0449.txt"
...
with open('evaluation_results_cs0449_testCode.json', 'w') as f:
    json.dump(results, f, indent=2)

print("\n" + "="*60)
print("Results saved to 'evaluation_results_cs0449_testCode.json'")
print("="*60)
...
#Training Starts here CS1502





training_data = "train_without_cs1502_03_27.jsonl"
testing_data = "test_cs1502_03_27.jsonl"
test_labels = "concepts_cs1502.txt"
...
with open('evaluation_results_cs1502_testCode.json', 'w') as f:
    json.dump(results, f, indent=2)

print("\n" + "="*60)
print("Results saved to 'evaluation_results_cs1502_testCode.json'")
print("="*60)
...
#Training Starts here CS1550





training_data = "train_without_cs1550_03_27.jsonl"
testing_data = "test_cs1550_03_27.jsonl"
test_labels = "concepts_cs1550.txt"
...
with open('evaluation_results_cs1550_testCode.json', 'w') as f:
    json.dump(results, f, indent=2)

print("\n" + "="*60)
print("Results saved to 'evaluation_results_cs1550_testCode.json'")
print("="*60)
